...
audience: mixed
status: reviewed
source_paths: wiki/component/box_integration.md
...
- [[wiki/component/parse]] — optional `--upload` flow
- [[wiki/tension/box_vs_local]] — open design tension between local-only and Box-backed operation

...
audience: mixed
status: reviewed
source_paths: wiki/schema/observation_schema.md
...
- [[wiki/schema/silver_layer]] — DLT-loaded silver table structure
- [[wiki/schema/gold_layer]] — dbt-built gold models
- [[wiki/component/observe]] — observation extraction
- [[wiki/component/surfactant_plugins]] — plugin architecture

...
grounded_by:
  ...
  - ../pEyeON-Analytics/wiki/file_formats/pe.md
...
<!-- GROUND_TRUTH: ../pEyeON-Analytics/wiki/components/container.md §dependencies -->
...
<!-- GROUND_TRUTH: ../pEyeON-Analytics/wiki/file_formats/pe.md §imphash -->
...
<!-- GROUND_TRUTH: ../pEyeON-Analytics/wiki/file_formats/elf.md §telfhash -->
...
- [[wiki/file_formats/pe]] — PE-specific imphash extraction
- [[wiki/file_formats/elf]] — ELF-specific telfhash extraction
- [[wiki/schemas/observation_schema]] — fuzzy hash storage in `raw_obs`
- [[wiki/concepts/supply_chain_risk]] — threat landscape context
